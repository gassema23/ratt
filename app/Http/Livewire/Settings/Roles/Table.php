...
final class Table extends PowerGridComponent
{
    ...
    */
    ...
    {
        return [
            Column::make(trans('role'), 'name')
                ->sortable()
                ->searchable(),
            Column::make(trans('nb. permissions'), 'permissions_count'),
    ...
    public function actions(): array
    {
        return [
            Button::add('editrecord')
                ->bladeComponent('editrecord', ['id' => 'id', 'route' => 'settings.roles.edit']),
    ...
    public function actionRules(): array
    {
        return [
            ...
            Rule::button('editrecord')
                ->when(fn () => !auth()->user()->can('roles-edit'))
                ->hide(),
            Rule::button('deleterecord')
                ->when(fn () => !auth()->user()->can('roles-delete'))
                ->when(fn ($role) => in_array($role->name, ['Super-Admin', 'Admin']))
                ->hide(),
        ];
    }
}
