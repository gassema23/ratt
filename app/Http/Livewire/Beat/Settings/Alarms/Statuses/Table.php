...
final class Table extends PowerGridComponent
{
    ...
    public $model = AlarmStatus::class;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\AlarmStatus>
     */
    public function datasource(): Builder
    {
        return AlarmStatus::query();
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('label')
            ->addColumn('updated_at_formatted', fn (AlarmStatus $model) => $model->updated_at->format('Y-m-d H:i:s'));
    }
    ...
    */
    ...
    /**
     * PowerGrid AlarmStatus Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::add('editrecord')
                ->bladeComponent('editrecord', ['id' => 'id', 'route' => 'beat.settings.alarms.statuses.edit']),
    ...
    */
    ...
    /**
     * PowerGrid AlarmStatus Action Rules.
     *
    ...
    public function actionRules(): array
    {
        return [
            Rule::button('editrecord')
                ->when(fn () => !auth()->user()->can('alarmStatus-update'))
                ->hide(),
            Rule::button('deleterecord')
                ->when(fn () => !auth()->user()->can('alarmStatus-delete'))
                ->hide(),
        ];
    }
}
