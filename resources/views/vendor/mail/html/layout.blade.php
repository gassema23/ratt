                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="
                                                                                       ...
                                                                                       font-family: Lato, sans-serif;
                                                                                       ">
                                                                        {{ settings()->get('title_' . App::getLocale()) }}</span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    style="
                                                               ...
                                                               min-width: 600px;
                                                               display: table-cell;
                                                               vertical-align: top;color: #ecf0f1;font-size:10px;
                                                               ">
                                    <div style="color: #ecf0f1;height: 100%; width: 100% !important">
                                        <!--[if (!mso)&(!IE)]>
                                                                  <!-->
                                        <div
                                            style="
                                                                         ...
                                                                         border-left: 0px solid transparent;
                                                                         border-right: 0px solid transparent;
                                                                         border-bottom: 0px solid transparent;font-size:10px;
                                                                       ">
                                            <!--
                                                                     <![endif]-->
                                            <table
                                                style="font-size:10px;color: #ecf0f1;font-family: 'Lato', sans-serif"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    style="
                                                                                    ...
                                                                                    ">
                                                                    <span
                                                                        style="font-size:10px!important;color: #ecf0f1; line-height: 14px">{{ $subcopy ?? '' }}</span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
