@if(data_get($setUp, 'header.searchInput'))
    <div class="flex flex-row mt-2 md:mt-0 w-full justify-start sm:justify-center md:justify-end">
        <div class="relative w-full md:w-4/12 float-end float-right md:w-full lg:w-1/2">
            ...
            <input wire:model.debounce.600ms="search" type="text"
                   ...
                   class="placeholder-slate-400 block w-full float-right bg-white text-slate-700 border border-slate-300 py-2 px-3 leading-tight focus:outline-none focus:bg-white focus:border-slate-500 pl-10 dark:bg-slate-600 dark:text-slate-200 dark:placeholder-slate-200 dark:border-slate-500"
