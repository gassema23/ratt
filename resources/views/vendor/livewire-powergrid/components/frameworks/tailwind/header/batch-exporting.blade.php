@if($queues && $showExporting)
    ...
    @if($batchExporting && !$batchFinished)
        <div wire:poll="updateExportProgress"
             class="w-full my-3 px-4 bg-slate-100 py-3 text-center">
            ...
            <div
                class="bg-emerald-500 h-1 text-center"
    ...
    @if($batchFinished)
        <div class="w-full my-3 dark:bg-slate-800">
            <div x-data={show:true} class="">
                <div class="px-4 py-3 cursor-pointer bg-slate-100 shadow dark:bg-slate-600"
