                ...
                <div class="my-2 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4 my-2">
                            <x-datetime-picker :label="__('Started date')" wire:model.defer="started_at" without-time
                                :hint="trans('Field required')" />
                            <x-datetime-picker :label="__('Ended date')" wire:model.defer="ended_at" without-time
                                :hint="trans('Field required')" />
                        </div>
                    </div>
                    <div>
