            ...
            <x-slot name="content">
                ...
                <div class="my-2 grid grid-cols-2 gap-4">
                    <div class="col-span-4 grid grid-cols-2 gap-4">
                        <x-input wire:model.defer="region.name.en" :label="__('Region name [EN]')" :hint="trans('Field required')" />
                        <x-input wire:model.defer="region.name.fr" :label="__('Region name [FR]')" />
                    </div>
                </div>
            </x-slot>
            <x-slot name="action">
