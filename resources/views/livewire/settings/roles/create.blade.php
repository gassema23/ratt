                ...
                <div class="my-2">
                    ...
                    @foreach ($permissions as $permissionName => $permissionItems)
                        <div x-data="{ open: false }" class="my-4">
                            <button
                                class="flex items-center justify-between w-full text-sm px-4 py-2 font-medium text-left bg-slate-100 hover:bg-slate-200 focus:outline-none focus:ring focus:ring-teal-300"
