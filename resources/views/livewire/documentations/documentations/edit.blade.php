    ...
    <x-app-modal>
        <form wire:submit.prevent="save">
            ...
            <x-slot name="content">
                ...
                <div class="my-2 grid grid-cols-2 gap-4">
                    <x-input wire:model.defer="documentation.name.en" :label="__('Title [EN]')" :hint="trans('Field required')" />
                    <x-input wire:model.defer="documentation.name.fr" :label="__('Title [FR]')" />
                </div>
                <div class="my-2 grid grid-cols-1 gap-4">
                    <x-textarea wire:model.defer="documentation.description.en" :label="trans('Description [EN]')" />
                    <x-textarea wire:model.defer="documentation.description.fr" :label="trans('Description [FR]')" />
                </div>
                <div class="my-2 grid grid-cols-1 gap-4">
