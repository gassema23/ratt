            ...
            <x-slot name="content">
                ...
                <div class="my-2 grid grid-cols-7 gap-4">
                    <div class="col-span-1">
                        <x-input wire:model.defer="alarm.code" :label="trans('Severity code')" :hint="trans('Field required')" />
                    </div>
                    <div class="col-span-3">
                        <x-input wire:model.defer="alarm.label.en" :label="trans('Severity name [EN]')" :hint="trans('Field required')" />
                    </div>
                    <div class="col-span-3">
                        <x-input wire:model.defer="alarm.label.fr" :label="trans('Severity name [FR]')" />
                    </div>
                </div>
