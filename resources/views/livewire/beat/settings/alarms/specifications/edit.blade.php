        ...
        <form wire:submit.prevent="save">
            ...
            <x-slot name="content">
                ...
                <div class="my-2 grid grid-cols-2 gap-4">
                    <x-input wire:model.defer="alarm.label.en" :label="trans('Specification name [EN]')" :hint="trans('Field required')" />
                    <x-input wire:model.defer="alarm.label.fr" :label="trans('Specification name [FR]')" />
                </div>
